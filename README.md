...
| **M1** | Complete ARMv6 (ARM1176) interpreter, unit-tested | 🔵 in progress — *70 tests passing* |
| **M2** | S5L8900 bring-up: bare-metal payload prints over emulated UART | 🔵 started — *MMU done* |
